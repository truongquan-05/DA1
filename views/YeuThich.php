...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/shop/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 12:24:37 GMT -->
<!-- Added by HTTrack -->
						...
						<?php foreach ($data as $values) : ?>
							<tr class="border">
								<th scope="row" class=" ps-xl-10 py-6 d-flex align-items-center border-0">
									<a href="#" class=" d-block text-muted fw-lighter"><i
											class="fas fa-times"></i></a>
									<div class="d-flex align-items-center">
										<div class="ms-6 me-7">
											<img src="../admin/image/<?= $values['hinh_anh'] ?>" class="img-fluid lazy-image" height="100" width="75" alt="">
										</div>
										<div>
											<a href="index.php?act=chi_tiet_san_pham&id=<?= $values['id_san_pham'] ?>" class=" text-body-emphasis fw-semibold mb-5"><?= $values['ten_san_pham'] ?></a>

										</div>
									</div>
								</th>
								<td class=" align-middle text-end pe-10">
									<a onclick="return confirm('Chắc chắn xóa?')" class="btn fs-15px px-9 lh-sm btn-outline-dark" href="index.php?act=yeu_thich_delete&id=<?= $values['id_san_pham'] ?>" class="me-6">Bỏ thích</a>
								</td>
							</tr>
